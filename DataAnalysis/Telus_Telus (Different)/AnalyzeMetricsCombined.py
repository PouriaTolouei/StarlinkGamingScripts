...
def graphDistr(metrics1, metrics2, xLabel, fileName, minm, maxm, step, width, height):
    ...
    plt.plot(set1.keys(), set1.values(), marker='', label='Victoria Telus 1 CDF', color='red')
    plt.plot(set2.keys(), set2.values(), marker='', label='Victoria Telus 2 CDF', color='blue')
...
testNum = 1 
folderNames = ['Telus (Panmi3)', 'Telus (Pantrig)']
